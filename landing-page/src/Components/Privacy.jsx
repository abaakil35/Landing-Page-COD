  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
        ...
        <h2
          id="info-collected"
          className={`font-bold mb-6 ${isDark ? "text-white" : "text-black"}`}
        >
        ...
        <ul className={isDark ? "text-gray-300" : "text-gray-700"}>
          ...
          <li>
            ...
            website and Services, including pages visited, features used,
            referral sources, time of access, and error logs.
          </li>
          <li>
        ...
        <ul className={isDark ? "text-gray-300" : "text-gray-700"}>
          ...
          <li>
            Communicate with you, including sending updates, security alerts,
            and marketing (with your consent where required).
          </li>
        ...
        <ul className={isDark ? "text-gray-300" : "text-gray-700"}>
          <li>
            <strong>GDPR (General Data Protection Regulation)</strong>: For
            users in the European Economic Area (EEA). We rely on grounds such
            as consent, contract performance, legitimate interests, and legal
            obligations. You have rights like access, rectification, erasure,
            and portability.
          </li>
          <li>
            <strong>CCPA (California Consumer Privacy Act)</strong>: For
            California residents. We collect categories of personal information
            as described above. You have rights to know what data we collect,
            delete it, opt-out of sales, and non-discrimination.
          </li>
          <li>
            <strong>
            ...
            : For Canadian users. We ensure accountability, identifying
            purposes, consent, limiting collection/use, accuracy, safeguards,
        ...
        <p className={isDark ? "text-gray-300" : "text-gray-700"}>
          ...
          "session" (expire when you close your browser) or "persistent" (stay
        ...
        <ul className={isDark ? "text-gray-300" : "text-gray-700"}>
          ...
          <li>
            Law enforcement, regulators, or other parties when required by law
            or to protect our rights.
          </li>
          <li>
            In connection with a merger, acquisition, or asset sale — in such
            case we will notify affected users.
          </li>
        </ul>
        ...
        <p className={isDark ? "text-gray-300" : "text-gray-700"}>
          ...
          third-party services (e.g., analytics, advertising, payment
          processors). We are not responsible for the privacy practices of those
        ...
        <p className={isDark ? "text-gray-300" : "text-gray-700"}>
          ...
          to protect personal information. However, no system is completely
          secure — if you suspect a security breach, contact us immediately at
        ...
        <p className={isDark ? "text-gray-300" : "text-gray-700"}>
          ...
          country, your personal data may be transferred to, stored, and
          processed in countries with different data protection laws. We take
          steps to ensure appropriate safeguards are in place (e.g., Standard
        ...
        <p className={isDark ? "text-gray-300" : "text-gray-700"}>
          ...
          believe we have collected such data, contact us and we will take steps
          to remove it.
        </p>
        ...
        <p className={isDark ? "text-gray-300" : "text-gray-700"}>
          ...
          contact us at support@codrocket.com. We may need to verify your
        ...
        >
          ...
          not constitute legal advice. If you need a legally compliant policy
          for your jurisdiction, consult a lawyer.
        </p>
      </div>
    </div>
  );
