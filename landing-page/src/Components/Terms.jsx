...
const Terms = () => {
  return (
    <div className="max-w-4xl mx-auto py-24 px-6">
      ...
      <h2 id="acceptance" className="text-2xl font-bold text-black mb-6">
        1. Acceptance of Terms
      </h2>
      <p className="text-gray-700 leading-relaxed mb-6">
        By accessing and using COD Rocket's services, you accept and agree to be
        bound by the terms and provision of this agreement. If you do not agree
        to abide by the above, please do not use this service.
      </p>

      <h2 id="description" className="text-2xl font-bold text-black mb-6">
      ...
      <h2 id="user-accounts" className="text-2xl font-bold text-black mb-6">
        3. User Accounts
      </h2>
      <p className="text-gray-700 leading-relaxed mb-6">
      ...
      <h2 id="acceptable-use" className="text-2xl font-bold text-black mb-6">
        4. Acceptable Use
      </h2>
      <p className="text-gray-700 leading-relaxed mb-6">
      ...
      <p className="text-gray-700 leading-relaxed mb-6">
        All content, trademarks, and materials provided through our services are
        owned by COD Rocket or our licensors and are protected by intellectual
        property laws. You may not reproduce, distribute, or create derivative
        works without our express written permission.
      </p>

      <h2 id="payment" className="text-2xl font-bold text-black mb-6">
        6. Payment and Billing
      </h2>
      <p className="text-gray-700 leading-relaxed mb-6">
        Certain services may require payment. All fees are non-refundable unless
        otherwise specified. You agree to pay all charges associated with your
        account. We reserve the right to change our pricing at any time with
        reasonable notice.
      </p>

      <h2 id="termination" className="text-2xl font-bold text-black mb-6">
        7. Termination
      </h2>
      <p className="text-gray-700 leading-relaxed mb-6">
      ...
      <h2 id="disclaimers" className="text-2xl font-bold text-black mb-6">
        8. Disclaimers and Limitation of Liability
      </h2>
      <p className="text-gray-700 leading-relaxed mb-6">
        Our services are provided on an "as is" and "as available" basis. We
        make no warranties, expressed or implied, regarding the operation of our
        services or the information, content, or materials included. To the
      ...
      <h2 id="indemnification" className="text-2xl font-bold text-black mb-6">
        9. Indemnification
      </h2>
      <p className="text-gray-700 leading-relaxed mb-6">
      ...
      <h2 id="governing-law" className="text-2xl font-bold text-black mb-6">
        10. Governing Law
      </h2>
      <p className="text-gray-700 leading-relaxed mb-6">
      ...
      <h2 id="changes" className="text-2xl font-bold text-black mb-6">
        11. Changes to Terms
      </h2>
      <p className="text-gray-700 leading-relaxed mb-6">
      ...
      <h2 id="contact" className="text-2xl font-bold text-black mb-6">
