...
const SeeAction = () => (
  <section className="relative w-full py-12 lg:py-20 px-4 lg:px-23 bg-[#FCFCFC] overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center relative z-10 gap-8 lg:gap-12">
      ...
      <div className="flex-1 w-full text-center lg:text-left px-4 lg:px-0">
        ...
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold mb-4 text-[#2d123a] drop-shadow-sm tracking-tight px-2 lg:px-0">
          See COD Rocket in Action
        </h2>
        <p className="text-base md:text-lg lg:text-xl text-[#3f3f3f] mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed px-2 lg:px-0">
        ...
        <ul className="space-y-4 lg:space-y-6 max-w-2xl mx-auto lg:mx-0">
          {checklist.map((item, idx) => (
            <li
              key={idx}
              className="flex items-center text-base md:text-lg text-[#2d123a] justify-center lg:justify-start"
            >
      ...
      <div className="flex-1 w-full flex justify-center items-center">
        <div className="relative w-full max-w-[500px] lg:max-w-[600px] h-[250px] md:h-[300px] lg:h-[400px] rounded-xl lg:rounded-2xl flex items-center justify-center shadow-xl lg:shadow-2xl overflow-hidden border-2 lg:border-4 border-[#9d3ecb]/10 bg-white/80 backdrop-blur-xl">
          <img
            src={demoImage}
            alt="Demo section"
